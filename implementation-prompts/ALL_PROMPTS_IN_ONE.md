# 🎯 Complete Architecture Reorganization - All Prompts in One File

این فایل شامل تمام پرامپ‌ها و دستورالعمل‌های لازم برای پیاده‌سازی بازآرایی معماری است.

---

## 📋 فهرست مطالب

1. [پرامپ کامل برای ربات (پیشنهادی)](#complete-robot-prompt)
2. [راهنمای کامل پیاده‌سازی](#full-implementation-guide)
3. [راهنمای فارسی](#persian-guide)
4. [راهنمای سریع](#quick-guide)
5. [پرامپ ساده AI](#simple-ai-prompt)

---

# 🤖 COMPLETE ROBOT PROMPT (پیشنهادی)
...
**START WITH PHASE 1, COMPLETE IT, THEN PROCEED TO PHASE 2, 3, AND 4 IN ORDER.**
