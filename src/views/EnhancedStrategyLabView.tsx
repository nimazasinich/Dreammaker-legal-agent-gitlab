...
export const EnhancedStrategyLabView: React.FC = () => {
  ...
  const handleDeleteStrategy = async (id: string) => {
    const confirmed = await confirm('Delete Strategy', 'Are you sure you want to delete this strategy?');
    if (confirmed) {
  ...
  const handleImportJSON = () => {
    ...
    input.onchange = async (e: Event) => {
      ...
      try {
        ...
        const shouldSave = await confirm('Save Strategy', 'Strategy loaded successfully! Would you like to save it as a template?');
        if (shouldSave) {
