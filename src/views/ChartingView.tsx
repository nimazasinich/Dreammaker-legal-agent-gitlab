...
import {
  ...
  ChevronDown, Eye, EyeOff, Grid, Zap, Target, // TrendingFlat (not available in lucide-react),
  Search, Plus, X
} from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div className="md:col-span-3 flex gap-2">
              <button
                onClick={reload}
                disabled={loading}
                className="flex-1 px-4 py-2 rounded-lg card-base hover:shadow-md transition-all flex items-center justify-center gap-2"
